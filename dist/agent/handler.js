...
const webhook_verification_1 = require("./webhook-verification");
/**
...
function createAgentHandler(config) {
    async function POST(request) {
        try {
            ...
            const verification = (0, webhook_verification_1.verifyWebhookSignature)(endpointSecret, signatureHeader, rawBody);
